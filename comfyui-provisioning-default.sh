...
NODES=(
    "https://github.com/ltdrdata/ComfyUI-Manager"  # Essential for managing extensions
)

# Minimum required checkpoint models
CHECKPOINT_MODELS=(
...
# Optional components - commented out for base installation
ESRGAN_MODELS=(
)
